        ...
        <div class="container mx-auto px-4">
            <div class="header-content flex items-center space-x-8">
                <div class="flex-shrink-0">
                    <img src="{{ URL::asset('images/icon.png') }}" alt="Dagohoy Municipal Seal" class="w-32 h-32 object-contain">
                </div>
                <div class="text-left">
                    <h1 class="text-4xl font-bold text-gray-400 mb-2">Sangguniang Bayan of Dagohoy</h1>
...
@include('inc.Cnav')
    ...
    <style>
        ...
        .main-header {
            ...
            background-image: url("{{ URL::asset('images/dagohoy.jpg') }}");
