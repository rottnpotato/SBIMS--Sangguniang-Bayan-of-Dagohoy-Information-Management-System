...
class DocumentController extends Controller
{
    public function generateReport(Request $request)
    {
        ...
        if (file_exists(public_path('images/icons.png'))) {
            ...
            $html .= '<img src="data:image/png;base64,' . $imageData . '" style="width: 75px; height: 75px;"><br>';
        }
        
        $html .= '<strong style="font-size: 12pt;">Republic of the Philippines</strong><br>';
        $html .= '<span style="font-size: 11pt;">Province of Bohol</span><br>';
        $html .= '<span style="font-size: 11pt;">Municipality of Dagohoy</span><br>';
        $html .= '<strong style="font-size: 12pt;">OFFICE OF THE 17TH SANGGUNIANG BAYAN</strong><br><br>';
